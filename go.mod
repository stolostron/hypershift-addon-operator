...
require (
	...
	github.com/openshift/cluster-api-provider-agent/api v0.0.0-20250613153211-1c77bd5386e7 // indirect
	...
	sigs.k8s.io/cluster-api-provider-kubevirt v0.1.8 // indirect
